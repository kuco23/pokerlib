...
table.publicIn(player3.id,enums.RoundPublicInId.CALL)
table.publicIn(player1.id,enums.RoundPublicInId.CALL)
table.publicIn(player2.id, enums.RoundPublicInId.CHECK)
table.publicIn(player3.id, enums.RoundPublicInId.CHECK)
table.publicIn(player1.id, enums.RoundPublicInId.RAISE, raise_by=50)
